...
void Fallen::Update(float _DeltaTime)
{
	...
	{
		BodyCollider_->Collision(CollisionType::Rect, CollisionType::Rect, static_cast<int>(UIRenderOrder::Player), std::bind(&Fallen::EnemyCollision, this, std::placeholders::_1), std::bind(&Fallen::EnemyCollisionEnd, this, std::placeholders::_1));
	}
}
